  ...
  return (
    <div className="rounded-2xl shadow-md hover:shadow-md overflow-hidden mb-3">
      ...
      <div className="bg-white pt-10 px-6 pb-8">
        <h3 className="text-2xl font-semibold text-brand mb-3">{visa.title}</h3>

        <p className="text-base text-gray-500 font-medium mb-4">
          Sed gravida nisl a porta tincidunt. Integer theoo aliquam nisi sit
          amet.
        </p>
